...
#ifndef _GAGE_CS_PROTOTYPESNEW_H_
#define _GAGE_CS_PROTOTYPESNEW_H_
...
#define FS_API	__stdcall			// Function exported by CsFs.dll
	...
	// Status
#ifdef __linux__
	//TODO: RG int32 SSM_API CsGetEventHandle(CSHANDLE hSystem, uInt32 u32EventType, EVENT_HANDLE* phEvent);
#else
...
#define CsGetErrorString CsGetErrorStringA
	...
	int32 SSM_API CsStmGetTransferStatus(CSHANDLE CsHandle, uInt16 nCardIndex, uInt32 u32WaitTimeoutMs, uInt32 *u32ErrorFlag, uInt32 *u32ActualSize, uInt8 *u8EndOfData);
...
#ifdef __linux__
	//RG - HAVE TO FIX TO USE TCHAR * instead of char *
